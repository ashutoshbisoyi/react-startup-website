  ...
  return (
    <>
      <ServicePageFrame
        ...
        h1='Business Consulting from HonourCreators'
        linkName='Order Now'
        linkAddress='/services'
        heading='Why you need'
        headspan='Business Consulting'
        ...
        imgDivClasses='service-img business-consulting'
        sampleheader='Business Consulting'
        database={BusinessConsultingData}
        formdescription='get a good consultancy now'
        option1='₹4,999-₹9,999'

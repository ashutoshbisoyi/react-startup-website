  ...
  return (
    <>
      <ServicePageFrame
        ...
        h1='Poster Making with HonourCreators'
        linkName='Order Now'
        ...
        imgDivClasses='service-img poster-making'
        sampleheader='Poster'
        database={PosterMakingData}
        formdescription='lets make a amazing banner'
        option1='₹4,999-₹9,999'

  ...
  return (
    <>
      <ServicePageFrame
        ...
        h1='Custom Printing with HonourCreators'
        linkName='Order Now'
        ...
        imgDivClasses='service-img custom-printing'
        sampleheader='Print'
        database={CustomPrintingData}
        formdescription='lets print your brand everywhere'
        option1='₹4,999-₹9,999'
